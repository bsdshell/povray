...
#case (0)
  #declare Camera_Location = < 2.50, 2.50,-20.00> ;  // front view
  #declare Camera_Look_At  = < 2.50, 2.50 , 0.0> ;
  #declare Camera_Angle    =  25 ;
#break
#case (1)
  #declare Camera_Location =  <6.40 ,6.5 ,-2.5> ;  // diagonal view
  #declare Camera_Look_At  =  <2.65 , 2.0 , 1.35> ;
  #declare Camera_Angle    =  75 ;
#break
#case (2) // aspect ratio 1:1  commandline:  +w320 +h320
  #declare Camera_Location =  <6.40 ,6.5 ,-2.5> ;  // diagonal view
  #declare Camera_Look_At  =  <2.65 , 2.0 , 1.35> ;
  #declare Camera_Angle    =  62 ;
#break
#case (3)
...
//--------------------------------------------------------------------------
// sun ---------------------------------------------------------------------
light_source{< 1500,3000, -500> color rgb<1,1,1>*0.9}                // sun 
...
sphere{<0,0,0>,1 hollow 
              texture{pigment{gradient <0,1,0> scale 2
                              color_map{[0.0 color rgb<1,1,1>  ]
                                        [0.4 color rgb<1,0.7,0.0> ]
                                        [0.6 color rgb<1,0.7,0.0> ]
                                        [1.0 color rgb<1,1,1>  ]}
                              quick_color White }
...
union{
 ...
 text   { ttf "timrom.ttf",  "x",  0.15,  0  texture{Tex_Dark} 
          rotate<40,-45,0> scale 0.65 translate <AxisLenX+0.45,0.2, 0.10> no_shadow}
#end // of #if 
#if (AxisLenY != 0)
 object { Axis_(AxisLenY, Tex_Dark, Tex_Light)   rotate< 0,0,  0>}// y-Axis
 text   { ttf "timrom.ttf",  "y",  0.15,  0  texture{Tex_Dark}    
          rotate<40,0,0> scale 0.65 translate <-0.55,AxisLenY+0.20,-0.10>  rotate<0,-45,0> no_shadow}
#end // of #if 
#if (AxisLenZ != 0)
 object { Axis_(AxisLenZ, Tex_Dark, Tex_Light)   rotate<90,0,  0>}// z-Axis
 text   { ttf "timrom.ttf",  "z",  0.15,  0  texture{Tex_Dark}
          rotate<30,-35,0> scale 1.2 translate <-0.75,0.2,AxisLenZ+0.10> no_shadow}
#end // of #if 
} // end of union                      
...
object{ AxisXYZ( 4.9, 4.65 ,21, Texture_A_Dark, Texture_A_Light) scale 1 }
